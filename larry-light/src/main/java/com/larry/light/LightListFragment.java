...
public abstract class LightListFragment extends LightFragment {

    private static final boolean DEBUG = false;
    private static final String TAG = "LightListFragment";
    ...
    protected int getLayoutResource() {
        return R.layout.light_fragment_recycleview;
    }
