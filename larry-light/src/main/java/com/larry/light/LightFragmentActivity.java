...
public abstract class LightFragmentActivity extends AppCompatActivity {
    ...
    protected void loadFragment(Fragment fragment, Bundle bundle) {
        ...
        LightFragmentUtils.replaceFragment(R.id.layout_container_main, getSupportFragmentManager(), fragment, bundle);

    }

    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Fragment fragment = getSupportFragmentManager().findFragmentById(R.id.layout_container_main);
        if (fragment != null) {
