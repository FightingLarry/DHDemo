...
public class AMSBinderHookUtil {

    public static void hook() throws Exception {
        final String service = Context.ACTIVITY_SERVICE;
        ...
        // 一般来说这是一个Binder代理对象
        IBinder rawBinder = (IBinder) getService.invoke(null, service);

        // Hook 掉这个Binder代理对象的 queryLocalInterface 方法
        // 然后在 queryLocalInterface 返回一个IInterface对象, hook掉我们感兴趣的方法即可.
        IBinder hookedBinder = (IBinder) Proxy.newProxyInstance(serviceManager.getClassLoader(),
                new Class<?>[] {IBinder.class}, new AMSBinderProxyHookHandler(rawBinder));
        ...
        cache.put(service, hookedBinder);
    }
}
