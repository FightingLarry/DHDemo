...
public class ApkUtil {
    ...
    public static InstallResult install(Context context, String apkPath, String pkgName) {
        ...
        if (TextUtils.isEmpty(apkPath)) {
            Log.w("ContextUtils", "download complete intent has no path param");
        ...
        if (!file.exists()) {
            Log.d("ContextUtils", apkPath + " not exists");
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            Log.w(TAG, "install message:  " + installResult.message + "   " + apkPath);
            return installResult;
        }
